 ...
 * About this Page : ApplyLeaveManager
 */
...
public class ApplyLeaveManager {
	...
	public String toString() {
		return "ApplyLeaveManager [id=" + id + ", empId=" + empId + ", firstName=" + firstName + ", lastname="
				+ lastname + ", leaveType=" + leaveType + ", startDate=" + startDate + ", endDate=" + endDate
				+ ", period=" + period + ", leaveComment=" + leaveComment + ", status=" + status + "]";
	}
