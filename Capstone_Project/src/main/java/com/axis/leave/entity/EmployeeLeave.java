...
public class EmployeeLeave {
	...
	public EmployeeLeave(int id, int empId, String firstName, String lastname, String leaveType, String startDate,
	...
	public String toString() {
		return "Employee_Leave [id=" + id + ", empId=" + empId + ", firstName=" + firstName + ", lastname=" + lastname
