...
<%@ include file="/views/adminDashboard.jsp" %>
  <div id="content">
                <!-- dashboard inner -->
                <div>
                    <p class="text-center text-dark" style="font-size: 30px;">Add New Employee Details</p>
                    <br>
                    <hr>
                    <form action="/addEmployee" method="post" onsubmit="return validate()">
                        <div>
                            <br>
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="EmployeeId"
                                            ...
                                            value="<c:out value='${newEmpId}'/>" readonly>  
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="EmpFirstName"
                                            placeholder="First Name" name="empFirstName" required>
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="EmpLastName"
                                            placeholder="Last Name" name="empLastName" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select class="form-select pb-4" aria-label="Default select example" id="selectRole" name="empRole" required style="width:350px">
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="EmployeeContact"
                                            placeholder="Contact Number" name="empContact" required>
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="email" class="form-control" id="EmployeeEmail"
                                            placeholder="Email address" name="empEmail" required>
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="date" class="form-control" id="EmployeeDOB"
                                            placeholder="EmployeeDOB" min="1972-01-01" max="2004-01-01" name="empDob" required>
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="date" class="form-control" id="EmployeeJoiningDate"
                                            placeholder="Joining Date" name="empJoining" required>
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="EmployeeUsername"
                                            placeholder="Set Username" name="empUsername" required>
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="password" class="form-control" id="EmployeePassword"
                                            placeholder="Set Password" name="empPassword" required>
