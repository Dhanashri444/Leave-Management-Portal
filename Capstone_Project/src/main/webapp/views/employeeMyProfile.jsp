...
<%@ include file="/views/employeeDashboard.jsp" %>
 ...
 <div id="content">
                <!-- dashboard inner -->
                <div>
                    <p class="text-center text-dark" style="font-size: 30px;">My Profile Details</p>
                    <br>
                    <hr>
                        ...
                        <div>
                            ...
                            <div class="row mb-4 mt-5">
                            	<div>
                            		<a href="employeeEditMyProfile?email=<c:out value='${empDetails.empEmail}'/>"><button class="btn btn-primary ps-4 pe-4">Edit</button></a>
                            	</div>
                            </div>
                            <br>
