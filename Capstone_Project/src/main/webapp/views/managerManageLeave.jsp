...
<div id="content">
                <!-- dashboard inner -->
                 <p class="text-center text-dark" style="font-size: 30px;">Manage Employee's Leave Request</p>
                    <br>
                    <hr>
				<table class="table table-success table-striped">
					...
					<tbody>
						<c:forEach items="${empLeavesList}" var="leaveList">
                    			<tr>
                    				...
                    				<td>
		            				<a href="managereditAction?id=<c:out value='${leaveList.id}'/>">
		            					<button  class="btn btn-info ps-3 pe-3 m-2">Approve/Reject</button>
		            				</a>
